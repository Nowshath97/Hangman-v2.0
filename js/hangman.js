...
function congrats() {
  ...
  if (score1 === score2) {
    let congratsmessage = '<div class="col-md-12 text-center">' +
      ' <button type="button" class="btn btn-warning" data-toggle="modal" data-target="#myModal0">End Game</button> </div>' +
      ' </div>'
    document.getElementById("end").innerHTML = congratsmessage;
  }


  if (score1 > score2) {
    let congratsmessage = '<div class="col-md-12 text-center">' +
      ' <button type="button" class="btn btn-warning" data-toggle="modal" data-target="#myModal1">End Game</button> </div>' +
      ' </div>'
    document.getElementById("end").innerHTML = congratsmessage;
  }
  if (score2 > score1) {
    ...
    let congratsmessage = '<div class="col-md-12 text-center">' +
      ' <button type="button" class="btn btn-warning" data-toggle="modal" data-target="#myModal2">End Game</button> </div>' +
      ' </div>'
    document.getElementById("end").innerHTML = congratsmessage;
  }
}
...
function checkIfGameLost() {
  if (mistakes === maxWrong) {
    ...
    //document.getElementById('lost').src='./images/wrongans.jpg';
  }
}
